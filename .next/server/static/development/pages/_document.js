...
class _Document extends next_document__WEBPACK_IMPORTED_MODULE_9___default.a {
  render() {
...
_Document.getInitialProps = async ctx => {
  ...
  const initialProps = await next_document__WEBPACK_IMPORTED_MODULE_9___default.a.getInitialProps(ctx); // Check if in production
